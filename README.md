...
O **Prime Açai** nasceu originalmente como um projeto de treinamento pessoal, com uma estrutura de código bem básica e crua. Se você quiser ver como era a arquitetura inicial do projeto, você pode conferir neste link: [Histórico Inicial - Código Cru](SEU_LINK_AQUI).
